...
- **Capacidades de IA Generativa:** Incorporacion del ecosistema LangChain 1.0.2, LangGraph 1.0.1, LangChain Community 0.4.1 y tiktoken 0.12.0 en ambas imagenes Docker (ray:2.41.0-py311-sunat-v8.3 y scipy-notebook:python-3.11-sunat-v9.3) para habilitar el desarrollo de aplicaciones con modelos de lenguaje (LLMs), cadenas de procesamiento y agentes inteligentes.
...
- **Actualizacion de Librerias Core:** Actualizacion de scikit-learn (1.8.0 a 1.7.2), pandas (2.1.1 a 2.2.3), requests (2.32.4 a 2.32.5), gensim (4.3.3 a 4.4.0) y pydantic (2.5.0 a 2.12.5) para correccion de vulnerabilidades, mejoras de rendimiento y compatibilidad con las nuevas dependencias.
- **Adicion de Librerias Numericas:** Incorporacion explicita de numpy 1.26.4 y matplotlib 3.9.4 en ambas imagenes para garantizar versiones consistentes en el entorno de computo distribuido (Ray) y notebooks (JupyterHub).
- **Compatibilidad con TF-Keras Legacy:** Incorporacion de tf-keras 2.20.1 en ambas imagenes Docker para garantizar compatibilidad con modelos y pipelines que utilizan la API `tf.keras` de TensorFlow 2.x, evitando rupturas en codigo existente al migrar a versiones superiores de TensorFlow donde Keras fue desacoplado.
...
### 3.1. Imagen Ray Cluster (ray:2.41.0-py311-sunat-v8.3)
...
docker pull miguelsff/ray:2.41.0-py311-sunat-v8.3

# 2. Guardar imagen como archivo tar para transferencia offline
docker save -o miguelsff-ray-2.41.0-py311-sunat-v8.3.tar miguelsff/ray:2.41.0-py311-sunat-v8.3

# 3. Cargar imagen en el entorno local de destino
docker load -i miguelsff-ray-2.41.0-py311-sunat-v8.3.tar

# 4. Etiquetar con destino al repositorio Harbor SUNAT
docker tag miguelsff/ray:2.41.0-py311-sunat-v8.3 vcf-np-w2-harbor-az1.sunat.peru/mlops/miguelsff/ray:2.41.0-py311-sunat-v8.3

# 5. Subir imagen al repositorio Harbor SUNAT
docker push vcf-np-w2-harbor-az1.sunat.peru/mlops/miguelsff/ray:2.41.0-py311-sunat-v8.3
```

### 3.2. Imagen JupyterHub Single User - Scipy Notebook (scipy-notebook:python-3.11-sunat-v9.3)
...
```bash
# 1. Descargar imagen desde Docker Hub
docker pull miguelsff/scipy-notebook:python-3.11-sunat-v9.3

# 2. Guardar imagen como archivo tar para transferencia offline
docker save -o miguelsff-scipy-notebook-python-3.11-sunat-v9.3.tar miguelsff/scipy-notebook:python-3.11-sunat-v9.3

# 3. Cargar imagen en el entorno local de destino
docker load -i miguelsff-scipy-notebook-python-3.11-sunat-v9.3.tar

# 4. Etiquetar con destino al repositorio Harbor SUNAT
docker tag miguelsff/scipy-notebook:python-3.11-sunat-v9.3 vcf-np-w2-harbor-az1.sunat.peru/mlops/miguelsff/scipy-notebook:python-3.11-sunat-v9.3

# 5. Subir imagen al repositorio Harbor SUNAT
docker push vcf-np-w2-harbor-az1.sunat.peru/mlops/miguelsff/scipy-notebook:python-3.11-sunat-v9.3
```
...
kubectl config use-context deploy-Mlops-User01
